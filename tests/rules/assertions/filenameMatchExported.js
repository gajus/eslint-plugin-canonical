  ...
  invalid: [
    {
      ...
      errors: [
        {column: 1, line: 1, message: 'Filename \'fooBar\' must match the exported name \'exported\'.'},
      ],
    ...
    },
    {
      ...
      errors: [
        {column: 1, line: 1, message: 'Filename \'foo\' must match the exported name \'Foo\'.'},
      ],
    ...
    },
    {
      ...
      filename: '/some/dir/foo.js',
      parserOptions: {ecmaFeatures: {jsx: true}, ecmaVersion: 6},
    },
    {
      code: exportedFunctionCode,
      errors: [
        {column: 1, line: 1, message: 'Filename \'bar\' must match the exported name \'foo\'.'},
      ],
    ...
    },
    {
      ...
      filename: '/some/dir/bar.js',
      parserOptions: {ecmaFeatures: {jsx: true}, ecmaVersion: 6, sourceType: 'module'},
    },
    {
      code: exportedEs6FunctionCode,
      errors: [
        {column: 1, line: 1, message: 'The directory \'fooBar\' must be named \'foo\', after the exported value of its index file.'},
      ],
    ...
    },
    {
      code: exportedVariableCode,
      errors: [
        {column: 1, line: 1, message: 'The directory \'eslint-plugin-canonical\' must be named \'exported\', after the exported value of its index file.'},
      ],
      filename: 'index.js',
      parserOptions: {ecmaVersion: 6, sourceType: 'module'},
    },
    {
      code: exportedJsxClassCode,
      errors: [
        {column: 1, line: 1, message: 'Filename \'Foo.react\' must match the exported name \'Foo\'.'},
      ],
    ...
    },
    {
      ...
      errors: [
        {column: 1, line: 1, message: 'Filename \'variableName\' must match the exported and transformed name \'variable_name\'.'},
      ],
    ...
    },
    {
      code: camelCaseEs6,
      errors: [
        {column: 1, line: 1, message: 'Filename \'variableName\' must match the exported and transformed name \'variable-name\'.'},
      ],
      filename: 'variableName.js',
      options: ['kebab'],
      parserOptions: {ecmaVersion: 6, sourceType: 'module'},
    },
    {
      code: camelCaseEs6,
      errors: [
        {column: 1, line: 1, message: 'Filename \'variableName\' must match the exported and transformed name \'VariableName\'.'},
      ],
      filename: 'variableName.js',
      options: ['pascal'],
      parserOptions: {ecmaVersion: 6, sourceType: 'module'},
    ...
    },
    {
      code: exportedEs6JsxClassCode,
      errors: [
        {column: 1, line: 1, message: 'Filename \'Foo.bar\' must match the exported name \'Foo\'.'},
      ],
    ...
    },
    {
      code: exportedEs6JsxClassCode,
      errors: [
        {column: 1, line: 1, message: 'The directory \'Foo.react\' must be named \'Foo\', after the exported value of its index file.'},
      ],
